            ...
            <div class="row">
                ...
                <form id="employeeForm" action="{{ route('employees.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <input class="col-md-9 form-control" type="text" name="name" id="name" placeholder="Nombre Completo del Empleado">
                    </div>
                    <div class="row">
                        <label class="col-md-2 form-label" for="email">
                            <strong>Correo Electronico *</strong>
                        </label>
                        <input class="col-md-9 form-control" type="email" name="email" id="email" placeholder="Correo Electronico">
                    </div> 
                    ...
                    <div class="row">
                        ...
                        <textarea class="form-control col-md-9" name="description" id="description" rows="3" placeholder="Descripcion de la Experiencia del Empleado"></textarea>
                    </div>
...
<script>
    $(document).delegate('.create-item', 'click', function () {
        let confirmation = confirm('¿Estás seguro que deseas crear este elemento?');
